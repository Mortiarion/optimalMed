...
//         const tooltip = document.getElementById("specializationTooltip");
//         tooltip.style.display = "block"; // Показуємо повідомлення про помилку
//         setTimeout(() => {
//             tooltip.style.display = "none"; // Приховуємо повідомлення через певний час (наприклад, після 3 секунд)
//         }, 3000);
//     }
